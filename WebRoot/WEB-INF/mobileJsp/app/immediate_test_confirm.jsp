...
<div class="container" style="top:0rem">
    ...
    <%--<div id="test_confirm" class="risk_assessment_test" onclick=confirm()>确认</div>--%>
    <div id="test_confirm" class="risk_assessment_test">确认</div>
...
<script>
    $("#test_confirm").click(function () {
        var resJson = {}
        resJson.status = "true"
        resJson.msg = "${bp.grade}"
        resJson.type = "0"
        AppInterface.nativeCallBack(JSON.stringify(resJson));
    })
