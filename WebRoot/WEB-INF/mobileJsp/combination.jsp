...
<div class="swiper-container swiper1 tit" style="display:none;">
    <div class="swiper-wrapper" style="height:0.9rem!important;">
        ...
        <div class="swiper-slide">担保物公示<i></i></div>
                ...
                <div class="page1" id="page2" style="display:none;">
                    ...
                    <div class="swiper2">
                        <div class="mySlide" style="overflow-x: hidden;" id="enterprise">
                            ...
                            <ul class="enterpriseContent">
                                ...
                                <c:choose>
                                    <c:when test="${plBidPlan.versionType  == 2 }">
                                        <li><span>企业法人</span>
                                            <span><c:if test="${enterprise.linkman} == ''">未填</c:if>
                                                    ${enterprise.linkman}</span></li>
                                        <li><span>统一信用代码</span>
                                            <span><c:if test="${enterprise.organizecode} == ''">未填</c:if>
                                                    ${enterprise.organizecode}</span></li>
                                    </c:when>
                                    <c:otherwise>
                                        <li><span>注册资金</span>
                        ...
                        <c:when test="${plBidPlan.versionType  == 2 }">
                            ...
                            <ul class="enterpriseContent" style="">
                                <li>
                                    <img class="db_pic" src="${base}/mobileNew/img/financeLease/bidDetail_db.png" alt="">
                                </li>
                                <li>
                                    <span>担保措施</span>
                                    <span>烟台山腾建筑工程机械有限公司承诺逾期债券回购；设备残余价值保障</span>
                                </li>
                            </ul>
                        </c:when>
                            <c:otherwise>
                        ...
                        <div class="mySlide" style="overflow-x: hidden;padding:0.2rem 0 0.3rem" id="publicity">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <div class="titleNav">
                                            <%--<span class="icon"></span>--%>
                                        <span class="title" style="padding-left:0.2rem;">经营公示</span>
                                    </div>
                                    ...
                                    <div class="titleNav">
                                            <%--<span class="icon"></span>--%>
                                        <span class="title" style="padding-left:0.2rem;">设备公示</span>
                                    </div>
                                    <p class="paging"><span id="paging_page_2">1</span>/${materials.size()}</p>
                                    <div class="License swiper6" style="margin-bottom: 1rem;">
                                        <div class="swiper-wrapper publicity_pic" >
    ...
    <div id="confirmBox"  style="display: none;width:100%;height:100%;">
        ...
        <ul class="confirm" id="confirm">
            ...
            <li>
                ...
                <p id="loanHints_6" style="display: none">*您输入的投资金额大于您的账户余额</p>
    ...
    function change(){
        ...
        if(str){
            if(str == ""){
                ...
                $("#loanHints_6").show().siblings().hide();
            }else{
