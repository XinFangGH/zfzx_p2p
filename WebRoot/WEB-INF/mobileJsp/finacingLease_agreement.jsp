...
<div class="fina_agree swiper-container">
    <div class="swiper-wrapper">
        <div class="swiper-slide" id="page1">
            <img src="${base}/mobileNew/img/mypic/fina_agree1.jpg" alt="">
        </div>
        <div class="swiper-slide" id="page2">
            <img src="${base}/mobileNew/img/mypic/fina_agree2.jpg" alt="">
        </div>
        <div class="swiper-slide" id="page3">
            <img src="${base}/mobileNew/img/mypic/fina_agree3.jpg" alt="">
        </div>
        <div class="swiper-slide" id="page4">
            <img src="${base}/mobileNew/img/mypic/fina_agree4.jpg" alt="">
        </div>
        <div class="swiper-slide" id="page5">
            <img src="${base}/mobileNew/img/mypic/fina_agree5.jpg" alt="">
        </div>
        <div class="swiper-slide" id="page6">
            <img src="${base}/mobileNew/img/mypic/fina_agree6.jpg" alt="">
        </div>
        <div class="swiper-slide" id="page7">
            <img src="${base}/mobileNew/img/mypic/fina_agree7.jpg" alt="">
        </div>
        <div class="swiper-slide" id="page8">
            <img src="${base}/mobileNew/img/mypic/fina_agree8.jpg" alt="">
        </div>
    </div>
</div>
