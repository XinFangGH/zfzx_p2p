    ...
    <div class="tool_content">
        ...
        <dl class="tool_introduce clearfloat">
            ...
            <dd>
                <h2>
                    收益计算器</h2>
                <span class="tool_detail">只要根据提示填写相关信息，即可一键计算，您在紫薇金融的投资收益，助您高效理财。</span></dd>
        </dl>
        <div class="tool_box clearfloat">
            <div class="tool_left clearfloat">
                ...
                <div class="tool_prompt" id="tipTender" style="display: none;">
                    紫薇金融奖励格式不正确，只能为正数</div>
                <div class="tool_item">
                    <span></span>
                    <div class="tool_form" style="width: 320px;">
                        <div id="rd">
                            <span style="display: none">
                                <input type="radio" name="Repayment" id="lblRepay1" value="每月付息" checked="checked"></span>
                            <label for="repay1" id="repay1" name="lblRepay1" class="checked">
                                每月付息</label>
                            
                            <span style="display: none">
                                <input type="radio" name="Repayment" id="lblRepay3" value="一次性"></span><label for="repay3" name="lblRepay3" id="repay3">一次性</label>
                            <span style="display: none">
                                <input type="radio" name="Repayment" id="lblRepay4" value="先息后本"></span><label for="repay4" name="lblRepay4" id="repay4">先息后本</label>
                            <span style="display: none">
                                <input type="radio" name="Repayment" id="lblRepay5" value="等额本息"></span><label for="repay5" name="lblRepay5" id="repay5">等额本息</label>
                            <span style="display: none">
                                <input type="radio" name="Repayment" id="lblRepay6" value="等本等息"></span><label for="repay6" name="lblRepay6" id="repay6">等本等息</label>
                        </div>
                    </div>
                </div>
                    ...
                    <dd>
                        <table width="100%" border="0" class="tool_table">
                            ...
                            <tr style="display: none;">
                                ...
                                <td>
                                    紫薇金融奖励：<strong><span id="span6">￥ 0</span></strong>
                                </td>
                            </tr>
                        </tbody></table>
                    </dd>
