...
<head> 
<title>升升投 - 理财计划</title>
    <meta name="description" content="${systemConfig.metaTitle} - 理财计划,专业的互联网投融资平台,中发展信（北京）投资管理有限公司,展信资本">
    <meta name="keywords" content="${systemConfig.metaTitle} - 理财计划,投资 融资 债权转让,中发展信（北京）投资管理有限公司,展信资本">
...
$("#tab-content .tb-c").hide().eq($('.tab-titles ul li').index(this)).show(); 
});
})
</script>
<script type="text/javascript">	
        ...
        <div class="xy-lc-content">
            <div class="xy-lc-install">
                <div class="xy-lc-custom">
                    <h1>${plan.mmName} &nbsp;&nbsp;&nbsp;&nbsp;<span>[${plan.manageMoneyTypeName}]</span>
                    <#if plan.novice==1><font class="newmm_font-one">新</font></#if>
                    <#if plan.addRate!=0&&plan.addRate!=""><font class="newmm_font-two">息</font></#if>
                    <#if plan.coupon==1><font class="newmm_font-three">券</font></#if></h1>
                    ...
                    <ul class="xy-lc">
                        <li><p class="xy-lc-key">预期年化收益率</p><p class="xy-lc-num" ><span style="font-size:42px;">${plan.yeaRate}</span>%<#if plan.addRate!=0&&plan.addRate!=""><font color="#EA0000" style="font-size:20px;color:#666;">+${plan.addRate}%</font></#if></p></li>
                        </p></li>
                    ...
                    <div class="xy-lc-detail xy-lc">
                     <div class="xy-lc-item-line"></div>
                        <div class="xy-lc-detail-item">
                            <p class="xy-lc-item-content"><img class="fl" src="${base}/theme/${systemConfig.theme}/images/ty-icon1.png" alt="">起投金额：<em><#if plan.startMoney==0>0.00<#else><#if plan.startMoneyy lt 1000>${plan.startMoney}<#else>${plan.startMoney?string(',###.00')}</#if></#if></em>元</p>
                        </div>
                        <div class="xy-lc-detail-item">
                            <p class="xy-lc-item-content"><img class="fl" src="${base}/theme/${systemConfig.theme}/images/ty-icon2.png" alt="">上限金额：<em>${plan.limitMoney}</em>元</p>
                        </div>
                   
                        <div class="xy-lc-detail-item">
                            <p class="xy-lc-item-content"><img class="fl" src="${base}/theme/${systemConfig.theme}/images/ty-icon3.png" alt="">投资期限：<em>${plan.investlimit}</em>个月</p>
                        </div>
                        <div class="xy-lc-detail-item">
                            <p class="xy-lc-item-content"><img class="fl" src="${base}/theme/${systemConfig.theme}/images/ty-icon4.png" alt="">还款方式：<em><#if  plan.isOne==0>按期收息,到期还本<#else>一次性支付利息 </#if></em></p>
                        </div>
                        <#if plan.coupon==1>
                         <div class="xy-lc-detail-item">
                            <p class="xy-lc-item-content"><img class="fl icon-one" src="${base}/theme/${systemConfig.theme}/images/ty-icon4.png" alt="">面值折现比：<em>${plan.returnRatio}</em>%</p>
            ...
            <div class="xy-lc-apply">
                ...
                <div class="xy-lc-apply-bd">
                	...
                	<input id="signMoney" onkeyup="lx('signMoney');" onblur="chkMoney('signMoney','currM');" class="xy-lc-input" placeholder="<#if plan.startMoney==0>0.00<#else><#if plan.startMoneyy lt 1000>${plan.startMoney}<#else>${plan.startMoney?string(',###.00')}</#if></#if>元起"><span class="xy-ft-unit">元</span>
                	<!--<div class="xy-ui-form-item-explain" style="display: none"></div>-->
                    <p class="xy-lc-amount-container">预估到期收益:<span class="xy-lc-amount-value" style="color:red;"></span>元</p>
                    ...
                    <div class="xy-lc-apply-sub">
                        ...
                        <#if plan.state=='1'>
                             <#if plan.startTime?date("yyyy-MM-dd HH:mm:ss") lt plan.nowDate?date("yyyy-MM-dd HH:mm:ss") >
                             	<a href="javascript:void(0);" class="xy-lc-apply-btn" onClick="show();" style="color:#F0F0F0">立即购买</a>
                             <#else>
        	...
        	<div class="tab_left">
                <div class="tab-titles">
                    <ul>
                         ...
                         <li>加入记录<em>（最近${buyInfoList?size!}条）</em></li>
                         <span class="sept">|</span>
                         <li>项目进程</li>
                         <span class="sept">|</span>
                         <li>债权信息</li>
                        ...
                        <div class="new">           
                                <ul class="xy-intro-list">
					                ...
					                <li class="xy-intro-row">
					                    ...
					                    <p><a class="btn1" target="_blank" href="${base}/creditFlow/financingAgency/planContractPlManageMoneyPlan.do" style="color:#fd7754"  >点击查看</a></p>
					                </li>
								</ul>
           				 </div>                     
                 </div>
                    ...
                    <div class="new">                     
			        	<ul class="mmplan_box">
			        		<li class="mmplan_list">
			        			...
			        			<div class="fl" style="padding: 20px 0;">
			        			<p class="tit">发布时间</p>
...
<!--end-->  
 ...
 <!-- 弹出框 -->
         <div class="xy-lc-box" id="xy-lc-box" style="display: none">
            ...
            <div class="xy-lc-box-show" style="width:800px;height:580px;">
                ...
                <div class="xy-lc-box-content" style="height:580px;">
                    ...
                    <div class="" style="float:left;width:50%;height:275px;border-right:1px dashed #E0E0E0"">
                          <div class="">
            		...
            		<#if plan.coupon==1>
                     ...
                     <div style="padding:15px 60px; overflow:hidden;clear:both;width:480px;">
				            ...
				            <span id="readAgreement_msg" style="float:right;"></span>
				     		<span id="readAgreement_msg_img" style="float:right;margin:1px 5px 0 40px;"></span>
				     </div>	
