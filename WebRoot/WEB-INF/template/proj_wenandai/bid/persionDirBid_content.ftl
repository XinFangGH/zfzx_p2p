...
<title>${systemConfig.metaTitle} - 招标信息详情</title>
    ...
    <meta name="description" content="${systemConfig.metaTitle} - 招标信息详情,专业的互联网投融资平台,中发展信（北京）投资管理有限公司,展信资本">
    <meta name="keywords" content="${systemConfig.metaTitle} - 招标信息详情,投资 融资 债权转让,中发展信（北京）投资管理有限公司,展信资本">
...
<script type="text/javascript" src="${base}/js/jquery.zlight.menu.1.0.min.js"></script>
...
$(function(){
	var a  = $("#showZQ").val();
	if(a!=null && a!='' &&  a!='undefined'){debugger
...
<!-- 开始 只需要拿这个说明标签之内的部分 --> 
<!-- 个人直投标 -->
<input type="hidden" id="bidType" value="pDir">
...
<#--<#include "/WEB-INF/template/${systemConfig.theme}/layout/share.ftl">-->
   ...
   <#-- <div class="inner"  id="header">
    	...
    	<div class="inner-left">        	
            <div class="condition">
                ...
                <dl class="didt didt-none">
                 <#if plan.proKeepType=="福利标">
                    ...
                    <dt>还款期限
                    &lt;#&ndash;<br/>
              		<span>借款周期（${plan.explain}）</span>&ndash;&gt;
              		</dt>
            ...
            <ul>
                ...
                <a href="${base}/html/secureSingle.do?toWhere=projectDesc#projectDesc">&lt;#&ndash;<span style="display:inline-block;" >[?]</span>&ndash;&gt;</a>
                </li>&ndash;&gt;
                 <!--<li><em><img src="${base}/theme/proj_wenandai/images/ty-icon2.png"  alt="" /></em>年化收益率：<span>12%</span>
                <a href="${base}/html/secureSingle.do?toWhere=projectDesc#projectDesc">&lt;#&ndash;<span style="display:inline-block;" >[?]</span>&ndash;&gt;</a>
                </li>&ndash;&gt;
                <!-- <li><em><img src="${base}/theme/proj_wenandai/images/ty-icon3.png"  alt="" /></em>债权到期日：<span>2016-08-24</span> &ndash;&gt;
               <!-- <a href="${base}/html/secureSingle.do?toWhere=projectDesc#projectDesc">&ndash;&gt;<!--<span style="display:inline-block;" >[?]</span>&ndash;&gt;<!--</a></li>&ndash;&gt;
                
             <#if plan.coupon==1>
	            	<li>
			               <font class="font-three">券</font>
			               面值折现比：<b class="red" style="font-weight:normal;">${plan.returnRatio}%</b>
                ...
                <!--<li><em><img src="${base}/theme/proj_wenandai/images/ty-icon4.png" /></em>保障方式：<span>本金保障</span>&ndash;&gt;
        ...
        <#else>
         <#if plan.preSaleTimeStr?date("yyyy-MM-dd HH:mm:ss") lt plan.nowTimeStr?date("yyyy-MM-dd HH:mm:ss") ><!-- 是否还在预售&ndash;&gt;
        <div class="inner-right1">
        	<i class="bg"></i>
        	<h3>投标中</h3>
            <div class="sumb">
            	<form id="bid_Form" action="${base}/creditFlow/financingAgency/bidingPlBidInfo.do" method="post">
                	...
                	<input type="text" name="sign_Money" style="width:249px;" id="sign_Money" onblur="chkMoney('sign_Money',${plan.afterMoney},'currM');" class="good_input" placeholder="输入金额需为${plan.startMoney}元的整数倍"/>

                	</div>
                    <ul>
                       <li style="height:14px; line-height:10px; "><span id="moneyspan"></span></li>
                       <li>剩余金额：<input type="hidden" id="afterM" value="${plan.afterMoney}"/><span style="color:#fd7754">${plan.afterMoney?string(',##0.00')}元</span></li>
                    ...
                    <#else>
                       <li>账户余额：<span style="color:#fd7754;" id="currM">${bpCustMember.availableInvestMoney?string(',##0.00')}</span></li>                       
                    </#if>
                    </ul>
                    <#if Session.successHtml=='undefined'||Session.successHtml==null>
  ...
  <#include "/WEB-INF/template/proj_wenandai/bid/welfare/welfare.ftl">
    ...
    <div class="finlist my-finlist">
       <ul class="finlist_title" id="zlight-nav">
            ...
            <ol style="display: block;">
                <div class="content">
                    <div class="contentleft">
                        <div class="contentleft1">
                            <span class="bg"></span>
                            <h5 class="td18">个人基本信息</h5>
                        </div>
                        <table class="my-table">
                            <tbody><tr>
                                <td class="td1">用户名：</td>
                                <td class="td2">
                            <#if planPro.loginName!="">${planPro.loginName?substring(0,1)}****${planPro.loginName?substring(planPro.loginName?length-1)}<#else>未填</#if>
                                </td>
                                <td class="td1">公司行业：</td>
                                <td class="td2"><#if planPro.companyIndustry!="null">${planPro.companyIndustry!}<#else>未填</#if></td>
                            </tr>
                            <tr>
                                <td class="td1">年　龄：</td>
                                <td class="td2"><#if planPro.age=="">未填<#else>${planPro.age!}</#if></td>
                                <td class="td1">公司规模：</td>
                                <td class="td2"><#if planPro.companyScale=="">未填<#else>${planPro.companyScale!}</#if></td>
                            </tr>
                            <tr>
                                <td class="td1">学　历：</td>
                                <td class="td2"><#if planPro.education=="">未填<#else>${planPro.education!}</#if></td>
                                <td class="td1">岗位职位：</td>
                                <td class="td2"><#if planPro.position=="">未填<#else>${planPro.position!}</#if></td>
                            </tr>
                            <tr>
                                <td class="td1">学　校：</td>
                                <td class="td2"><#if planPro.educationSchool=="">未填<#else>${planPro.educationSchool!}</#if></td>
                                <td class="td1">工作城市：</td>
                                <td class="td2"><#if planPro.workCity=="">未填<#else>${planPro.workCity!}</#if></td>
                            </tr>
                            <tr>
                                <td class="td1">月收入：</td>
                                <td class="td2"><#if plan.monthIncome==0>未提供<#else>${plan.monthIncome!}元</#if></td>
                                <td class="td1">工作时间：</td>
                                <td class="td2"><#if planPro.workTime=="">未填<#else>${planPro.workTime!}</#if></td>
                            </tr>
                            <tr>
                ...
                <div class="content">
                    <div class="contentleft">
                        <div class="contentleft1">
                            <span class="bg"></span>
                            <h5 class="td17">项目信息</h5>
                        </div>
                        <table class="my-table">
                            <tbody>
                            <tr>
                                <td class="td1">项目描述：</td>
                                <td class="td3" colspan="3">${planKeep.proDes}</td>
                            </tr>
                            <tr>
                                <td class="td1">资金用途：</td>
                                <td class="td3" colspan="3">${planKeep.proUseWay!}</td>
                            </tr>
							<tr>
                            ...
                            <div class="htmleaf-container" style="width:100%x;margin-top: 20px;">
                                <div style="width: 845px;    margin: 0 auto;">
                                        <#-- <ul class="vmcarousel-centered-infitine vmc-centered vmcarousel"
                                             style="width: 5058px; margin-left: -281px; transition: transform 0.5s ease 0s;">-->
                                         <ul class="vmcarousel-centered-infitine vmc-centered" style="width: 1692px">
                                             <#list listMaterials as list>
                                             <li>
                                                 <img src="${base}/${list.imgUrl!}" alt=""
                                                      data_src="${base}/${list.imgUrl!}" width="260">
                                                 <div class="cover"></div>
		...
		<#-- <div class="finlist_hide">
              ...
              <div class="contentleft">
               ...
               <div style="float:left; width:350px; padding: 10px 0 0 0px;">
                <dl class="contentleft2">
                  ...
                  <dt class="dt1">用户名：</dt>
                  <dd><#if planPro.loginName!="">${planPro.loginName?substring(0,1)}****${planPro.loginName?substring(planPro.loginName?length-1)}<#else>未填</#if></dd>
               </dl>
                <dl class="contentleft2">
                  <dt class="dt1">年　龄：</dt>
                  <dd><#if planPro.age=="">未填<#else>${planPro.age!}</#if></dd>
               </dl>
               <dl class="contentleft2">
                  <dt class="dt1">学　历：</dt>
                  <dd><#if planPro.education=="">未填<#else>${planPro.education!}</#if></dd>
               </dl>
               <dl class="contentleft2">
                  <dt class="dt1">学　校：</dt>
                  <dd><#if planPro.educationSchool=="">未填<#else>${planPro.educationSchool!}</#if></dd>
               </dl>
               <dl class="contentleft2">
                 &lt;#&ndash; <dt class="dt1">婚　姻：</dt>
                  <dd><#if planPro.marriage??>${planPro.marriage!}<#else>未填</#if></dd>&ndash;&gt;
                  <dt class="dt1">月收入：</dt>
                  <dd><#if plan.monthIncome==0>未提供<#else>${plan.monthIncome!}元</#if></dd>
                </dl>
                <dl class="contentleft2">
                      <dt style="width:85px;">主要财务:</dt>
                ...
                <div style="float:left; width:350px;padding: 10px 0 0 100px;">
                   <dl class="contentleft2">
                      ...
                      <dd><#if planPro.companyIndustry!="null">${planPro.companyIndustry!}<#else>未填</#if></dd>
                   </dl>
                    <dl class="contentleft2">
                          <dt  class="dt2">公司规模：</dt>
                          <dd><#if planPro.companyScale=="">未填<#else>${planPro.companyScale!}</#if></dd>
                     </dl>
                      <dl class="contentleft2">
                          <dt  class="dt2">岗位职位：</dt>
                          <dd><#if planPro.position=="">未填<#else>${planPro.position!}</#if></dd>
                      </dl>
                      <dl class="contentleft2">
                          <dt  class="dt2">工作城市：</dt>
                          <dd><#if planPro.workCity=="">未填<#else>${planPro.workCity!}</#if></dd>
                      </dl>
                      <dl class="contentleft2">
                          <dt  class="dt2">工作时间：</dt>
                          <dd><#if planPro.workTime=="">未填<#else>${planPro.workTime!}</#if></dd>
                      </dl>
                      <dl class="contentleft2">
                            <dt style="width:100px;">主要债务:</dt>
          ...
          <div class="content">
              <div class="contentleft">
                <div class="contentleft1">
                    <span class="bg"></span>
                  <h5>信用评级：<span class="<#if planKeep.plKeepCreditlevel.name??>
                  ...
                  <#else>icon2</#if>">${(planKeep.plKeepCreditlevel.name)!}</span></h5>
                 </div>
              </div>
          </div>
          &lt;#&ndash;
              ...
              <div class="contentleft">
                <div class="contentleft1">
                  ...
                  <h5>风险控制</h5>
                   ...
                   <div class="txt">${planKeep.proRiskCtr!}</div>
              </div>
          </div>
         </ol>
          ...
          <#list  slFundList as list>
            ...
            <#if list.incomeMoney??>
              ...
              <!--<h2 class="title"><span>已还本息<#if sum1??>${sum1?string(",##0.00")}<#else>--</#if> 元</span> 待还本息<#if sum1?? && sum2??>${(sum2-sum1)?string(",##0.00")}<#else>--</#if>元</h2>&ndash;&gt;
              <div class="tab">
                  <table width="100%" class="tab_css_one" border="0" align="center" cellpadding="0" cellspacing="0">
                         <tr>
                      ...
                      <table width="100%" class="tab_css_one" border="0" align="center" cellpadding="0" cellspacing="0">
                           ...
                           <#if (pager.list !=null)>
                              ...
                              <tr>
                                 ...
                                 <td align="center">${list.outCustName?substring(0,2)}****${list.outCustName?substring(list.outCustName?length-2)}</td>
                                 <td align="center">${list.inCustName?substring(0,2)}****${list.inCustName?substring(list.inCustName?length-2)}</td>
