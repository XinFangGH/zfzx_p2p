...
<input type="hidden" id="bidType" value="pOr">
    ...
    <div class="inner">
    	...
    	<div class="inner-left">        	
            <div class="condition">
            	<dl class="didt">
            	<dt>年利率</dt>
                	<dd><i>${(planPro.yearInterestRate)!}</i>% <#if plan.addRate!=0&&plan.addRate!=""><font color="#EA0000" size="font-size:20px;">+${plan.addRate}%</font>&nbsp;<font class="font-two">息</font></#if></dd>
                </dl>
                <dl class="didt">
                	<dt>总额</dt>
        ...
        <#elseif plan.state==3>
         ...
         <div class="inner-right1" >
            ...
            <div class="sumb">
            	<ul>
                    	<p style="padding:0 20px;color:#67C183;height:162px; overflow:hidden;">活动结束！</p>
                  </ul>
            </div>
        </div>
         <#else>
		 <div class="inner-right1" >
            ...
            <div class="sumb">
            	<ul>
                    	<p style="padding:0 20px;color:#fff;height:162px; overflow:hidden;">已流标！</p>
                  </ul>
            </div>
        </div>
        </#if>
        <#elseif plan.state==4>
		 <div class="inner-right1" >
            ...
            <div class="sumb">
            	<ul>
                    	<p style="padding:0 20px;color:#fff;height:162px; overflow:hidden;">已过期！</p>
                  </ul>
            </div>
        </div>
        <#else>
            ...
            <div class="sumb">
            	<form id="bid_Form" action="${base}/creditFlow/financingAgency/bidingPlBidInfo.do" method="post">
                    ...
                    <ul>
                      ...
                      <li><em><img src="${base}/theme/proj_wenandai/images/money-red.jpg" /></em>剩余金额：<input type="hidden" id="afterM" value="${plan.afterMoney}"/><span style="color:#fd7754">${plan.afterMoney?string(',##0.00')}元</span></li>
          ...
          <div class="content">    
            <div class="contentleft">
             ...
             <dl class="contentleft2">
                ...
                <dd><#if planPro.currentcompany=="">未填<#else>${planPro.currentcompany!}</#if></dd>
             </dl>
             <dl class="contentleft2">
                <#--<dt class="dt1">婚　姻：</dt>
                <dd>${planPro.marriage!}</dd>-->
                <dt class="dt1">月收入：</dt>
                <dd><#if planPro.jobincome=="">未提供<#else>${planPro.jobincome!}元</#if></dd>
              </dl>
              <dl class="contentleft2">
	            	...
	            	<table width="100%" class="tab_css_one" border="0" align="center" cellpadding="0" cellspacing="0">
	                      ...
	                      <#if (bondListBid!=null)>
	                        ...
	                        <tr>
	                           ...
	                           <td align="center">${list.userName?substring(0,1)}****</td>
	                           <td align="center">${list.bondTotelMoney?string(',###.00')}</td>
	                        </tr>
	                        </#if>
	                        </#list>
	                        </#if>
