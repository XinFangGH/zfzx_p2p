...
<div class="xywarp">
	<div class="xyhead">
		<div class="info clearfix">
			<div style="margin-right:10px;margin-bottom:30px;text-align: right;">
			 <a href="${base}/creditFlow/financingAgency/downPlanContractPlManageMoneyPlan.do?filename=wadContractTemplate.pdf">
			  <img style="cursor:pointer;" src="${base}/theme/proj_wenandai/images/xydownload.png" >
			  </a>
			</div>
	...
	<div class="xycon">
		<div id="content" style="padding: 5px 12px; font-size:12px">
			<br><br>
			<p align="center">
				<strong>升升投“升升投”系列服务计划协议书</strong>
			</p>
			<p style="width=98%;text-align:right"> 协议编号：____________</p>

            <p>甲方：____________________________________</p>
            <p>身份证件号码：___________________________</p>
            <p>联系电话：________________________________</p>
			...
			<p style="margin-left:30pt;">
				1.2 乙方作为一家在合法成立并有效存续的有限责任公司，拥有http://www.hurongsoft.com/ 网站（下称“升升投网站”或“升升投平台”）的经营权，主要通过升升投平台为互联网环境下自然人之间的借贷交易提供信息中介和居间撮合服务。
			</p>
            <p style="margin-left:30pt;">
			...
			<table border="1" style="margin: 0px auto; font-size:12px; border-collapse: collapse; border: 1px solid #000; width: 60%; ">
				<tbody>
					<tr height="25px">
						...
						<td style="padding: 4px 10px; font-weight:bold; "></td>
					</tr>
					<tr height="25px">
			...
			<p style="margin-left:30pt;">
				3.1名称：“升升投”服务计划XXXXXX期（上下文均称“本期服务计划”）。
			</p>
			<p style="margin-left:30pt;">
			...
			<p style="margin-left:30pt;">
				3.4加入金额要求：最低加入金额为人民币1000.00元，并以人民币1000.00元整数倍递增，最高不超过人民币 XXXXX元
			</p>
			<p style="margin-left:30pt;">
		...
		<div style="text-align: center">
      	...
      	<input type="hidden" value="41" name="templateId">
			...
			<input type="button" value="关 闭" align="center" onclick="javascript:window.close()" />
			 <a href="${base}/creditFlow/financingAgency/downPlanContractPlManageMoneyPlan.do?filename=wadContractTemplate.pdf">
				<img style="margin-right:10px;margin-bottom:10px;cursor:pointer;" src="${base}/theme/proj_wenandai/images/xydownload.png" align="right" >
			</a>
		</div>
	</div>
</div>
