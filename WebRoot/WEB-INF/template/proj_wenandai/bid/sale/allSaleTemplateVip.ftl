...
<script type="text/javascript">var m1="个人中心",m2="aaaa",m3="我的投资";</script>
...
<script type="text/javascript" >
	...
	function addPage(Nums){debugger;
		var url="${base}/creditFlow/financingAgency/showSaleRecordVipPlBidSale.do";
		var param={};
		if(Nums==7){//可交易债权
