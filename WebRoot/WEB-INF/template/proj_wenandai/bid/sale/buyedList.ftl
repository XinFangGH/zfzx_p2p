    	...
    	<div class="user-cont-right">
	       ...
	       <div class="cont-list">
		       <ul class="finlist_title">
		          ...
		          <li class="active"><a href="${base}/creditFlow/financingAgency/buyedListPlBidSale.do" >已购买债权</a></li>
				       ...
				       <div class="worm-tips">
		                ...
		                <table width="100%" class="tab_css_one" border="0" cellspacing="0" cellpadding="0">
		                    ...
		                    <tr>
		                     ...
		                     <td align="center" >
		                      <span style="display:inline-block;float:right;"><a href="javascript:void(0);" onClick="clickOrStartTransferFormsee(${list.bidInfoID},${list.yearAccrualRate},'${list.intentDate}','${list.startDate}','${list.id}')" class="btn1">结算清单</a>
