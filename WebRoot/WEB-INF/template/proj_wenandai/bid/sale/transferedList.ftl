		   ...
		   <div class="user-cont-right">
		       ...
		       <div class="cont-list">
			       <ul class="finlist_title">
			           ...
			           <li class="active"><a href="${base}/creditFlow/financingAgency/transferedListPlBidSale.do" >已卖出债权</a></li>
			       ...
			       <div class="finlist_hide">
				      <div class="tab-list">
		                ...
		                <table width="100%" class="tab_css_one" border="0" cellspacing="0" cellpadding="0">
		                    ...
		                    <tr>
		                     ...
		                     <a href="${base}/creditFlow/financingAgency/bidPlanDetailPlBidPlan.do?bidId=${list.bidPlanID}" target="_blank" title="${list.bidProName}(到期日:${list.intentDate};年化利率 :${list.yearAccrualRate}%)"><span class="tit">${list.bidProName}</span><div class="normal gray" style="text-indent:20px;">(到期日:${list.intentDate};年化利率 :${list.yearAccrualRate}%)</div></a>
		                      ...
		                      <td align="center" >
		                      <span ><a href="javascript:void(0);" onClick="clickOrStartTransferFormsee(${list.bidInfoID},${list.yearAccrualRate},'${list.intentDate}','${list.startDate}','${list.id}')" class="btn1">结算清单</a>
		               <#-- <a href="${base}/financePurchase/downLoadFinancePurchase.do?customerType=invest&contractUrl=${list.url}" class="btn2">转让合同</a></span></td>-->
		                <a href="${base}/creditFlow/financingAgency/contractPlBidSale.do?saleId=${list.id}" class="btn2">合同</a><span class="last"></span></span></td>
		
		                    </tr>
		                    </#list>
		              	</table>
		              		<#import "/WEB-INF/template/common/pager.ftl" as p>
		         		<@p.pager pager = transferedListpager baseUrl = "/creditFlow/financingAgency/transferedListPlBidSale.do?show=transferedList"  />
		            </div>
		     	</div>  
  			</div>
		</div>
