			                ...
			                <table width="100%" class="tab_css_one" border="0" cellspacing="0" cellpadding="0">
			                    ...
			                    <tr>
			                     ...
			                     <td align="center" >
			                      ...
			                      <a  href="javascript:void(0);" onClick="clickOrStartTransferFormsee(${list.bidInfoID},${list.yearAccrualRate},'${list.intentDate}','${list.startDate}','${list.id}')" class="btn2">结算清单</a></span></td>
