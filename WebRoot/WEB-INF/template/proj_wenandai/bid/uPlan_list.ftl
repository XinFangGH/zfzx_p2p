        ...
        <div class="investment">
        	...
        	<div class="investment-list">
        		<div class="fl w1015">
	        		...
	        		<div class="investment-dl">
	        			<div class="f16">借款金额：${list.sumMoney?string(',##0')}元</div>
	        			<div class="f16">计划期限：${list.investlimit}个月</div>
	        		</div>
	        		<div class="investment-dl">
	        			<div class="f16">锁定期：
	        			${list.lockingLimit}个月
						</div>
	        			<div class="f16">
	        				<span>投资进度：</span>
        		...
        		<div class="bid_list_btn fr">
		               <#if list.state=='1'>
		                 <#if list.startTime?date("yyyy-MM-dd HH:mm:ss") lt list.nowDate?date("yyyy-MM-dd HH:mm:ss") >
		    				<a href="${base}/creditFlow/financingAgency/getDetailPlManageMoneyPlan.do?mmplanId=${list.mmplanId}&keystr=UPlan" class="buttonorange orange-btn">购买中</a>
		                 <#else>
		                   <span class="buttongray gray-btn">预售中</span>
		                 </#if>
		               <#elseif list.state=='2'><span class="buttongray gray-btn">已售罄</span>
		               <#elseif list.state=='7'><span class="buttongray gray-btn">回款中</span>
		               <#elseif list.state=='10'><span class="buttongray gray-btn">已完成</span>
		               <#elseif list.state=='-1'||list.state=='-2'>
		              	<span class="buttongray gray-btn">已关闭</span>
		               </#if>
        		</div>
        	</div>
        </div> 
