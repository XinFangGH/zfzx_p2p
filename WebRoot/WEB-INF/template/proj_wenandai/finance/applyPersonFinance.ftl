...
$(function(){
	...
	$("#persion").click(function(){
		...
		$("#bussiness").css("background-color","#BEBEBE");
		$("#persion").css("background-color","#66B3FF");
		$("#applyBussinessForm").css("display","none");
	})
	$("#bussiness").click(function(){
		$("#bussiness").css("background-color","#66B3FF");
		$("#persion").css("background-color","#BEBEBE");
		$("#applyForm").css("display","none");
		$("#applyBussinessForm").css("display","block");
	})
});
</script>
...
<div style="width:100%; background:#eff3f3;">
 <div class="main">
	<div style="margin-bottom:10px;"><span id="persion" style="cursor: pointer;width:100px; height:30px; line-height:30px;background:#66B3FF;padding:6px 10px; font-size:16px;color:#fff;text-align:center; margin-right:20px;">【个人借款】</span>
	<span id="bussiness" style="cursor: pointer;width:100px; height:30px; line-height:30px;background:#BEBEBE;padding:6px 10px; font-size:16px;color:#fff;text-align:center; margin-right:20px;">【企业借款】</span><span style="font-size:15px; color:#555;">【<b>${loanProduct.productName}</b>】</span></div>
	<form id="applyForm" action="${base}/financePurchase/saveApplyFinancePurchase.do" onsubmit="return savePer()" method="post" accept-charset="utf-8">
...
我们的合作贷款机构中挑选出最适合您的机构及产品，并代理您办理各种复杂手续。</div>
        ...
        <div style="width:919px; height:70px; padding:20px 0px 0px 80px;">
          ...
          <div style="width:400px; height:30px; float:left;">
            <textarea id="remark" name="financeApply.remark"  class="colorful1" rows="3" cols="31" style="resize: none; height:100px;padding:10px;"></textarea>
          </div>
...
<form id="applyBussinessForm" style="display:none" action="${base}/financePurchase/saveApplyFinancePurchase.do" onsubmit="return saveBusiness()" method="post" accept-charset="utf-8">
 <input type="hidden" name="financeApply.productName" value="${loanProduct.productName}">
...
我们的合作贷款机构中挑选出最适合您的机构及产品，并代理您办理各种复杂手续。</div>
  ...
  <div id="tip-businessName"  style="width:400px; margin-left:40px;  height:24px; float:left; padding-top:6px">&nbsp;&nbsp;<span id="businessName_span" class="gray middle"></span></div>
    ...
    <div style="width:919px; height:30px; padding:30px 0px 0px 80px;">
      <div style="width:170px; height:27px; float:left; text-align:right; padding-top:8px"><span class="red middle" id ="businessName_x">*</span><span class="black middle">借款人姓名：</span></div>
      <div style="width:220px; height:30px; float:left;">
        <input id="linkPersionB" name="financeApply.linkPersion" type="text" tabindex="1" maxlength="20" size="30" class="colorful1"  onblur="chkLoanBussiness(this)"/>
      </div>
    ...
    <div style="width:919px; height:30px; padding:20px 0px 0px 80px;">
      <div style="width:170px; height:27px; float:left; text-align:right; padding-top:8px"><span class="red middle" id ="phone_x">*</span><span class="black middle">手机号码：</span></div>
      <div style="width:220px; height:30px; float:left;">
        <input id="phoneB" name="financeApply.phone" type="text" tabindex="2" maxlength="20" size="30" class="colorful1"  onblur="chkLoanBPhone(this)"/>
      </div>
	...
	<div style="width:919px; height:30px; padding:20px 0px 0px 80px;">
      <div style="width:170px; height:27px; float:left; text-align:right; padding-top:8px"><span class="black middle">所在地区：</span></div>
      <div style="width:220px; height:30px; float:left;">
      <input id="areaB" name="financeApply.area" type="text"  tabindex="3" maxlength="20" size="30" class="colorful1" />
    ...
    <div style="width:919px; height:30px; padding:20px 0px 0px 80px;">
      <div style="width:170px; height:27px; float:left; text-align:right; padding-top:8px"><span class="red middle" id ="money_x">*</span><span class="black middle">期望贷款金额（元）：</span></div>
      <div style="width:220px; height:30px; float:left;">
        <input id="loanMoneyB" name="financeApply.loanMoney" type="text"  tabindex="3" maxlength="20" size="30" class="colorful1"  onblur="chkLoanMoneyB(this);funFormat(this);"/>
      </div>
    ...
    <div style="width:919px; height:30px; padding:20px 0px 0px 80px;">
      <div style="width:170px; height:27px; float:left; text-align:right; padding-top:8px"><span class="red middle" id ="timeLen_x">*</span><span class="black middle"> 期望贷款期限（月）：</span></div>
      <div style="width:220px; height:30px; float:left;">
        <input id="loanTimeLenB" name="financeApply.loanTimeLen" type="text"  tabindex="4" class="colorful1"  size="30" onblur="chkLoanTimeB(this)"/>
      </div>
    ...
    <div style="width:919px; height:70px; padding:20px 0px 0px 80px;">
      <div style="width:170px; height:27px; float:left; text-align:right; padding-top:8px"><span class="black middle">借款用途：</span></div>
      <div style="width:400px; height:30px; float:left;">
        <textarea id="remarkB" name="financeApply.remark"  class="colorful1" rows="3" cols="31" style="resize: none; height:100px;padding:10px;"></textarea>
      </div>
      <div id="tip-remark" style="width:400px; height:24px; float:left; padding-top:6px">&nbsp;&nbsp;</div>
    </div>
