...
<!--start 网商贷-->
	...
	<div class="grid1">
    	 <h1 class="tit">薪资贷<span class="big">（适用工薪阶层）</span></h1>
         <div class="info-list-condition">
             <h2 class="mb15">申请条件</h2>
             <ul class="ui-list-disc">
                  <li><i></i>22-55周岁的中国公民</li>
                  <li><i></i>在现单位工作满6个月，已正式签 署劳动合同</li>
                  <li><i></i> 月收入2000元以上</li>
              </ul>
			 <div class="btn">
              <a href="${base}/financePurchase/creditInfoFinancePurchase.do?id=${id}" class="btnbg btnbg1">申请借款</a>	
			</div>
    	</div>
	           ...
	           <a href="javascript:void(0);">点击加载可选材料说明</a>
                ...
                <li>
                 ...
                 <li>
                    ...
                    <div class="idcard-div">
                        <span data="1" class="card-icon" style="cursor:auto;">
                        <span  style="display:inline-block;width:59px; height:99px;background:url(${base}/theme/${systemConfig.theme}/images/large-icon11.png) no-repeat";></span>
                        <b class="qxs">无样例</b>
                        </span>
                        <span class="line" ></span>
                      	<span data="2" class="card-icon1" tabindex="-1">                
                ...
                <li>
                    ...
                    <div class="idcard-div">
                        <span data="1" class="card-icon" style="cursor:auto;">
                         <span style="display:inline-block;width:106px; height:86px;background:url(${base}/theme/${systemConfig.theme}/images/large-icon12.png) no-repeat";></span>
                      <br />
                        <b class="qxs">无样例</b>
                        </span>
                        <span class="line" ></span>
...
<!--start 费用说明-->
    <div class="info-list-fee">
                        ...
                        <ul class="ui-list">
                            <li class="range">
                               <h4>期初服务费<span style="display:inline-block;margin-left:23px;"><em class="wad_dknamemoney">贷款本金的5%</em>（由升升投平台收取）</span></h4>
                                <!-- <h5>由升升投平台收取</h5> -->
                        ...
                        <!-- financePurchase/personInfoFinancePurchase.do-->
