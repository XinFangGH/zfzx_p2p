...
<!--start 网商贷-->
	...
	<div class="grid1" id="attestSlide">
    	 <h1 class="tit tit4">园丁贷<span class="big">( 适用教育工作者 )</span></h1>
         <div class="info-list-condition">
             <h2 class="mb15">申请条件</h2>
             <ul class="ui-list-disc">
                  <li><i></i>公立大中小学、幼儿园在职教师，或各级教育管 理事业单位在职人员</li>
                  <li><i></i>具备教师资格</li>
                  <li><i></i>中国大陆籍公民</li>
             </ul>
             <div class="btn">
            ...
            <ul class="ui-list-disc">
                ...
                <li>
                    ...
                    <div class="idcard-div">
                        ...
                        <a title="教师资格认证" href="${base}/theme/${systemConfig.theme}/images/samples/teacher1.jpg">
...
<!--start 费用说明-->
    <div class="info-list-fee">
                        ...
                        <ul class="ui-list">
                            <li class="range">
                               <h4>期初服务费<span style="display:inline-block;margin-left:23px;"><em class="wad_dknamemoney">贷款本金的5%（目前专属优惠活动，只收3%）</em>（由升升投平台收取）</span></h4>
                                <!-- <h5>由升升投平台收取</h5> -->
