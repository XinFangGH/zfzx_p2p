            ...
            <ul>
	           <!-- <li class="wad_yibao">
                ...
                <li class="wad_shouyi wad_touzi">
                    <p class="wad_syjeheader"><span>累计投资(元)</span></p>
                    <p class="wad_shouyijine"><#if bpCustMember.totalInvestMoney==0>0.00<#else><#if bpCustMember.totalInvestMoney lt 1000>${bpCustMember.totalInvestMoney}<#else>${bpCustMember.totalInvestMoney?string(',###.00')}</#if></#if>元</p>
                </li>
