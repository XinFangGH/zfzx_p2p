...
<head>
    ...
    <title>${systemConfig.metaTitle} - 资金存管</title>
    <meta name="description" content="${systemConfig.metaTitle} - 资金存管,专业的互联网投融资平台,中发展信（北京）投资管理有限公司,展信资本">
    <meta name="keywords" content="${systemConfig.metaTitle} - 资金存管,投资 融资 债权转让,中发展信（北京）投资管理有限公司,展信资本">
<#include "/WEB-INF/template/${systemConfig.theme}/layout/all.ftl">
    ...
    <script type="text/javascript">var m1="关于我们",m2="",m3="资金存管";</script>
    ...
    <div class="abouts-cont fr">
        <div class="abouts-border"  style="padding:30px 40px;min-height: 590px;">
            <div class="company_title">
                ...
                <span  class="company_title_JJ">资金存管</span>
            </div>
            ...
            <ul class="loginreg_content"><#--.media-cont {padding: 20px 0;}-->
                <li >
                    <div class="loginreg_lan" >
                        <span class="new-list fl  loginreg_itle" >什么是资金存管</span>
                ...
                <li >
                    <div class="loginreg_lan" >
                        <span class="new-list fl  loginreg_itle" >实现银行存管之后，是如何保障用户资金安全</span>
                        <span class="fr slide_div"></span>
                    </div>
                    <div class="loginreg_div">
