...
<head>
    <title>${systemConfig.metaTitle} - 财务报告</title>
...
<#include "/WEB-INF/template/${systemConfig.theme}/layout/all.ftl">
    ...
    <script type="text/javascript">var m1="关于我们",m2="",m3="财务报告";</script>
    ...
    <div class="abouts-cont fr" >
        <div class="abouts-border" style="padding:30px 40px; min-height: 1060px;">
            <div class="company_title">
                ...
                <span  class="company_title_JJ">财务报告</span>
            </div>
            <ul class="media-cont news_list">
            <#--<#list pager.list as list>	-->
                <li class="media-list" >
					<span class="new-list fl" >
						<a href="<#--${base}/article/newscontentArticle.do?catId=${list.id}-->"><#--${list.title}--></a>
					</span>
