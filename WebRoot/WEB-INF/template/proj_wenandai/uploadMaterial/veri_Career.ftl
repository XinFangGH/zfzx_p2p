...
<body >
	...
	<form>
	<h3>工作认证</h3>
    <p class="text">工作认证是衡量借款人还款能力及信用的重要依据。</p>
     <div id="attestSlide">
    <ul class="attes">
    	<h4>认证说明：</h4>
    	<li>（1）就职单位开具的在职证明<span class="sample"><a class="sample"title="在职证明" href="${base}/theme/${systemConfig.theme}/images/samples/proof.jpg">
                    <i style="font-style:normal;">   （点击样例）</i></a></span></li>
        <li>（2）与就职单位签订的劳动合同或聘用合同照片<span class="sample"><a class="sample"title="劳动合同" href="${base}/theme/${systemConfig.theme}/images/samples/laborcontract2.jpg">
                    <i style="font-style:normal;">   （点击样例）</i></a></span></li>
    </ul>
    <ul class="attes">
