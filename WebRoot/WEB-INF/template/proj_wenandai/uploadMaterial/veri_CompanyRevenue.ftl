...
<head>
<title>${systemConfig.metaTitle} - 经营收入认证</title>
<!-- 上传文件js开始-->
...
<body >
	...
	<form>
	<h3>经营收入认证</h3>
    <p class="text">企业经营收入状况是衡量借款人还款能力及信用的<span style="color:red;">必要</span>依据。</p>
    <div id="attestSlide">
    <ul class="attes">
    	<h4>认证说明：</h4>
    	<li>（1）体现经营情况的近6个月<span style="color:#555;">个人</span>银行卡流水单或网银截图<span class="sample"><a class="sample"title="银行流水单" href="${base}/theme/${systemConfig.theme}/images/samples/bankwater.jpg">
                    <i style="font-style:normal;">   （点击样例）</i></a></span></li>
        <li>（2）体现经营情况的近6个月<span style="color:#555;">企业</span>银行卡流水单或网银截图<span class="sample"><a class="sample"title="网银明细1" href="${base}/theme/${systemConfig.theme}/images/samples/bankdetails1.png">
                    <i style="font-style:normal;">  （点击样例）</i></a></span></li>
    </ul>
    <ul class="attes">
    ...
    <div class="picture">
    	<h4><span>*</span>上传经营收入证明：</h4>
         ...
         <input type="hidden" value="CompanyRevenue" name="type"/>
