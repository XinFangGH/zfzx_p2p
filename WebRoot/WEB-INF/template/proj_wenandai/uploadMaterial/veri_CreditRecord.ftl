...
<head>
<title>${systemConfig.metaTitle} - 信用认证</title>
<!-- 上传文件js开始-->
...
<body >
	...
	<h3>信用认证</h3>
	 <div id="attestSlide">
    <p class="text">“个人信用报告”是由中国人民银行出具的，全面记录个人经济活动，反应个人基本信用状况的资料。其中所记录的各种信用记录，将成为升升投核定您信用等级的重要依据，及投资人为您投标的依据。
    <span class="sample"><a style="color:#6496fe;" title="信用认证"  href="${base}/theme/${systemConfig.theme}/images/samples/creditreport.jpg">
                    <i style="font-style:normal;">（点击样例；查询个人征信报告的方法）</i></a></span>
    </p>
    </div>
    <ul class="attes">
    	<h4>认证说明：</h4>
    	<li>（1）15日内开具的“个人信用报告”</li>
    </ul>
     <ul class="attes">
    	<h4>认证条件：</h4>
    	<li>信用记录良好</li>
    ...
    <div class="picture">
        ...
        <form id="myForm" action="${base}/material/updateStateMaterial.do" method="post" >
         ...
         <input type="hidden" value="CreditRecord" name="type"/>
