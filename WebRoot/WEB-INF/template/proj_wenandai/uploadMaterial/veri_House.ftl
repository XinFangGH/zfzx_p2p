...
<head>
<title>${systemConfig.metaTitle} - 房产认证</title>
<!-- 上传文件js开始-->
...
<body >
	...
	<form>
	<h3>房产认证</h3>
    <p class="text">房产认证是衡量借款人信用及还款能力的有力依据</p>
    <div id="attestSlide">
    <ul class="attes">
    	<h4>认证说明：</h4>
    	<li>（1）房产证所有页照片<span class="sample"><a class="sample"title="房产认证" href="${base}/theme/${systemConfig.theme}/images/samples/room1.jpg">
                    <i style="font-style:normal;">   （点击样例）</i></a></span></li>
    </ul>
    </div>
     <ul class="attes">
    	<h4>认证条件：</h4>
    	<li>必须是商品房，且房产是本人名下所有或共有的</li>
    </ul>
    <ul class="attes">
