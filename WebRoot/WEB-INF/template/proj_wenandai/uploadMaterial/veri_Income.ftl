...
<head>
<title>${systemConfig.metaTitle} - 收入认证</title>
<!-- 上传文件js开始-->
...
<body >
	...
	<form>
	<h3>收入认证</h3>
    <p class="text">您的银行流水单是升升投评估您收入状况及还款能力的<span style="color:red">必要</span>依据。</p>
    <div  id="attestSlide">
    <ul class="attes">
    	<h4>认证内容：<span style="color:#555; font-size:12px;">请提交下面中的某一项资料</span></h4>
    	<li>（1）可体现本人收入的最近6个月的银行流水单<span class="sample"><a class="sample"title="银行流水单" href="${base}/theme/${systemConfig.theme}/images/samples/bankwater.jpg">
                    <i style="font-style:normal;">   （点击样例）</i></a></span></li>
    	<li>（1）可体现本人收入的最近6个月的网银截图<span class="sample"><a class="sample"title="网银明细" href="${base}/theme/${systemConfig.theme}/images/samples/bankdetails1.png">
                    <i style="font-style:normal;">   （点击样例）</i></a></span></li>
