...
<head>
<title>${systemConfig.metaTitle} - 居住认证</title>
<!-- 上传文件js开始-->
...
<body >
	...
	<form>
	<h3>居住认证</h3>
    <p class="text">居住的稳定性是衡量借款人信用的有力依据。</p>
     <div  id="attestSlide">
	    <ul class="attes">
	    	<h4>认证内容：</h4>
	    	<li>（1）本人姓名登记的水、电、气最近3个月缴费单<span class="sample"><a class="sample"title="月缴费单" href="${base}/theme/${systemConfig.theme}/images/samples/dianfen.jpg">
	                    <i style="font-style:normal;">（点击样例）</i></a></span></li>  
	    	<li>（2）本人自有房产证明<span class="sample"><a class="sample"title="房产证明" href="${base}/theme/${systemConfig.theme}/images/samples/room1.jpg">
	                    <i style="font-style:normal;"> （点击样例）</i></a></span></li>  
	    	<li>（3）本人父母的房产证明，及本人与父母关系的证明材料</li>      
	    </ul>
    	...
    	<h4><span>*</span>上传居住证明：</h4>
         ...
         <form id="myForm" action="${base}/material/updateStateMaterial.do" method="post" >
         	 ...
         	 <input type="hidden" value="${loadid}" name="loadid" id="loadid"/>
         	  ...
         	  <input type="hidden" value="Residence" name="type"/>
