...
<head>
<title>${systemConfig.metaTitle} - 学生认证</title>
<!-- 上传文件js开始-->
...
<body >
	...
	<form>
	<h3>学生认证</h3>
    <p class="text">您上传的学生证照片需清晰显示学籍相关信息，且在有效期内。</p>
    <div  id="attestSlide">
    <ul class="attes">
    	<h4>认证内容：<span style="color:#555; font-size:12px;">请提交下面中的某一项资料</span></h4>
    	<li>（1）本人学生证照片页及信息页照片<span class="sample"><a class="sample"title="学生证样例" href="${base}/theme/${systemConfig.theme}/images/samples/xueshengzheng.jpg">
