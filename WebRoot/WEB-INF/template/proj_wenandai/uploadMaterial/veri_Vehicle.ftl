...
<head>
<title>${systemConfig.metaTitle} - 购车认证</title>
<!-- 上传文件js开始-->
...
<body >
	...
	<form>
	<h3>购车认证</h3>
    <p class="text">购车认证是衡量借款人信用及还款能力的重要依据</p>
     <div  id="attestSlide">
    <ul class="attes">
    	<h4>认证内容：</h4>
    	<li>（1）车辆行驶证的原件照片<span class="sample"><a class="sample"title="车辆行驶证" href="${base}/theme/${systemConfig.theme}/images/samples/runningcard2.jpg">
                    <i style="font-style:normal;">   （点击样例）</i></a></span></li>  
    	<li>（2）本人和车辆的合影<span class="sample"><a class="sample"title="本人和车辆的合影" href="${base}/theme/${systemConfig.theme}/images/samples/carandperson.png">
                    <i style="font-style:normal;">   （点击样例）</i></a></span></li>     
    </ul>
    </div>
    <ul class="attes">
