...
<body >
	...
	<div class="bpbox">
	<h3>网店认证</h3>
    <p class="text">网店真实性是衡量借款人还款能力及信用的重要依据。</p>
    <ul class="attes">
    	<h4>认证内容：</h4>
    	<li>（1）网店网址</li>   
    </ul>
    <ul class="attes">
    	<h4>认证条件：</h4>
    	<li>网址真实有效，且与升升投要求相吻合</li>
    
    </ul>
    
    <ul class="attes">
    	<h4>认证有效期：<span style="color:red">永久</span></h4>
    	<li>上传资料：您网店的地址为<input type="text"/></li>
    </ul>
   		<form id="form1" action="${base}/FileUploadServlet" method="post" enctype="multipart/form-data">
	        ...
	        <form id="myForm" action="${base}/material/updateStateMaterial.do" method="post" >
	         	  ...
	         	  <input type="button" class="btn" style="padding:5px 25px;background:#2770b8;color:#fff;margin-left:200px"  onClick="closeDiag()" value="提交审核"/>
	        </form>
