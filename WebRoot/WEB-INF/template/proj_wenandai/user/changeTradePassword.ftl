...
<script type="text/javascript" src="${base}/js/user/changeTradepassword.js"></script>
<script type="text/javascript" src="${base}/js/user/check.js"></script>

<script type="text/javascript">var m1="个人账户",m2="个人主页",m3="账户安全";</script><style type="text/css">
	a.getcode.disabled {
		color: #d5d5d5;
		cursor: default;
	...
	<div class="main">
	    ...
	    <div style="float:left; width:740px; margin:10px 0px 0px 0px; overflow:hidden;">
	    	...
	    	<div style="width:680px; padding:20px 40px; overflow:hidden;" class="account-info">
	        	<!--此处放置内容-->
	        	<#include "/WEB-INF/template/common/user/updateUserDealPwdSetp1.ftl">
	        	<!--放置内容结束-->
