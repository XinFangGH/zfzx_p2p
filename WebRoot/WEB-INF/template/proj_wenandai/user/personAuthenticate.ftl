...
<script type="text/javascript" src="${base}/js/user/personAuthenticate.js"></script>
 ...
 <#include "/WEB-INF/template/${systemConfig.theme}/layout/topall.ftl">
    ...
    <div class="ucrightdiv">
    	<!-- 我的个人信息 start -->
        	...
        	<img src="${base}/theme/${systemConfig.theme}/images/spicon1.jpg" style="vertical-align:middle; margin:0px 20px 7px 0px;" />
            	<span class="blue large">个人实名认证</span>
            </div>
            <div class="dashedline"></div>
        	<div style="width:680px; padding:20px 40px; overflow:hidden;" class="account-info">
            	<!--此处放置内容-->
            	<#include "/WEB-INF/template/common/user/userAuthenticate.ftl">
            	<!--放置内容结束-->
