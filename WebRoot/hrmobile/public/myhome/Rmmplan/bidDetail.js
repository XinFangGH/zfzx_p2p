...
var pltype
var Rmmdata
var salebuystyle="margin:20px 10px 40px 10px;height:44px;background:"+themeColor+";font-color:white";
var saledisable=false;
Ext.define('hrmobile.public.myhome.Rmmplan.bidDetail', {
	extend: 'Ext.Panel',
    name: 'bidDetail',
    constructor: function (config) {
    	...
    	if(Rmmdata.saleStatus=="3"){
    		salebuystyle ="margin:20px 10px 40px 10px;height:44px;background:"+nobtncolor+";font-color:white";
    		saledisable=true;
    	}
