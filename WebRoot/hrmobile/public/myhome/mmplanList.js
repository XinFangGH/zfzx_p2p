...
//creditorList.js
Ext.define('hrmobile.public.myhome.mmplanList', {
    	...
    	Ext.apply(config,{
		    ...
		    loadfunction:function(this1,records){
		    	for (var i=records.length-1; i >= 0; i--) {  
				    recordsmmplanList.push( records[i] );  
		    	}  
				recordsmmplanList.forEach(function(e){
    		...
    		fields:[ {
    	        ...
    	        url : __ctxPath + '/creditFlow/financingAgency/allPlmanagemoneyPlBidSale.do',
	    		root:'result',
					                    ...
					                    '</div>'+
					                     '<div class="content_right rg">'+
							                        '<div class="index-progress">'+
							                            '<center><canvas id="mmplan{mmplanId}" width="70" height="70"></canvas></center>'+
