...
//creditorList.js
Ext.define('hrmobile.public.myhome.planbid.Paymentplan', {
    ...
    constructor: function (config) {
		...
		items:[
	        {
	        	html: '' +
	        	  '<div class="record-table" style="padding:10px 0 0 0 !important;margin-top:42px;">'+
...
//	                  '<td style="padding:0 !important;width:22%;"><span class="font14">{factDate:this.factDate}</span></td>'+
	                   // 计划回款款金额
	                  '<td width="22%">{payIntestPrinMoney}元</td>'+
	                  
	                   // 实际回款金额
	                  '<td width="20%">{factPaymentsMoney}元</td>'+
