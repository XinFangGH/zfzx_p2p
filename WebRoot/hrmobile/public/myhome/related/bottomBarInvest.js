...
Ext.define('hrmobile.public.myhome.related.bottomBarInvest', {
    extend: 'Ext.Container',
    
    name:'bottomBarInvest',
		...
		Ext.apply(config,{docked:'bottom',laout:'hbox',items:[
			...
			items:[{
						...
						handler:this.toindex},
					{
						xtype:'button',
						style:'border-radius:0px; padding:0;border:0',
						text:"<img  style='width:100%; height:auto; ' src='hrmobile/resources/imagesP2p/wytz_select.jpg' />",
						width:"25%",
					...
					{
						xtype:'button',
						text:"<img  style='width:100%; height:auto; ' src='hrmobile/resources/imagesP2p/ptgg.jpg' />",
						width:"25%",
						style:'border-radius:0px; padding:0;border:0',
						handler:this.toptgg}]		
