...
BpCustLoginlogView = Ext.extend(Ext.Panel, {
			...
			initUIComponents : function() {
				...
				this.topbar = new Ext.Toolbar({
						items : [{
									iconCls : 'btn-add',
									text : '添加[BpCustLoginlog]',
									xtype : 'button',
									scope : this,
									handler : this.createRs
								}, {
									iconCls : 'btn-del',
									text : '删除[BpCustLoginlog]',
									xtype : 'button',
									scope:this,
				...
				this.gridPanel=new HT.GridPanel({
					...
					url : __ctxPath + "/user/listBpCustLoginlog.do",
					fields : [{
									name : 'id',
									type : 'int'
								}
			...
			removeRs : function(id) {
				$postDel({
					url:__ctxPath+ '/user/multiDelBpCustLoginlog.do',
					ids:id,
					grid:this.gridPanel
				});
			},
