package com.hurong.core.DataInit;
 ...
 * <B>
 * <P>
 * Hurong -- http://www.credit-software.com
 * </P>
 * </B> <B>
 * <P>
 * Copyright (C)  JinZhi WanWei Software Company (北京金智万维软件有限公司)
 * </P>
 * </B> <B>
 * <P>
	...
	public static void initNode(Element rootEl, Object parentObj) {
		if (rootEl != null) {
			...
			while (model_It.hasNext()) {
				...
				try {
					com.hurong.core.model.BaseModel model = (com.hurong.core.model.BaseModel) Class
