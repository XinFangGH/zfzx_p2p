...
public class BpCoupons extends com.zhiwei.core.model.BaseModel {
	...
	public static final String COUPONRESOURCE_NORMAL="couponResourceType_normal";//普通生成优惠券方法
	public static final String COUPONRESOURCE_ACTIVE="couponResourceType_active";//活动生成优惠券方法
	...
	protected java.math.BigDecimal couponMoney;//返现金额
	...
	private String intention;//优惠券来源操作点
	private String couponsDescribe ="" ;//优惠券活动说明
	

	//数据库没有字段
	private String resourceName;//优惠券来源
	private String activityNumber;//活动编号（非活动来源没有编号）
	private String logginName;//bp_cust_member用户表登录名称
