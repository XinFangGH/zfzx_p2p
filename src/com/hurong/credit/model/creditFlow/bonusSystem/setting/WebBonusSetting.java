package com.hurong.credit.model.creditFlow.bonusSystem.setting;
/*
 ...
 *
 */
public class WebBonusSetting extends com.hurong.core.model.BaseModel {
	
    protected Long   bonusId;
    
    /*******************积分开启条件******************************/
	protected String userAction;//Action类名
	protected String userActionKey;//Action方法名
	/**
	 *  ["登录", "Login"],
		["注册", "register"],
		["投标", "tender"],
	...
	protected String memberLevel = "0";//会员等级id
	protected String memberLevelValue;//会员等级
	protected String bonusswitch;//积分规则开关  0开，1关
	 ...
	 *  3论坛积分
	 */
	protected String bonusType;//积分类型
	protected String bonusName;//奖励方式名称
	
	protected String bonus;//奖励分值
	
	protected String isBonus = "1";//奖惩措施   1增加积分，2扣除积分
	
	protected String bomusPeriod;//奖励周期
	/**
	 * ["一次性","once"],["分钟","min"], ["小时","hour"], ["天","date"]
	 */
	protected String bomusPeriodType;//奖励周期类型
	
	
	protected String periodBonusLimit = "1";//奖励周期内奖励次数
	
	protected String sendMsgType;//通知用户方式
	protected String description;//积分规则说明
	
	protected String bonusIntention;//积分用意   如：登录 、注册、
