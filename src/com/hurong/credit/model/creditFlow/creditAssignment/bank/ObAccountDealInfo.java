...
public class ObAccountDealInfo extends com.zhiwei.core.model.BaseModel {
	...
	public static final String T_TRANSFERPAY="12";//系统账户转账支出
    ...
    public static final String T_REPAYMENT_COMPENSATORY="34";//代偿回收
    public static final String T_OBLIGATIONDEAL="35";//债权交易
    public static final String T_LOANINCOMEFEE="36";//提现手续费收入
    ...
    public static  final Short DEAL_STATUS_9 =Short.valueOf("9");//9：银行处理中
    
    protected Long id;//系统账户交易明细表主键Id
	protected Long accountId;//系统账户表主键id
	protected java.math.BigDecimal incomMoney=new BigDecimal(0);//收入金额
	protected java.math.BigDecimal payMoney=new BigDecimal(0);//支出金额
	protected java.math.BigDecimal currentMoney=new BigDecimal(0);//发生该笔交易后账户的余额
	protected String transferType;//交易类型    参见以上常量字段
	protected Long shopId;//发生交易的线下门店Id
	protected String shopName;//发生线下交易的门店名称
	protected Long createId;//创建交易记录的人员Id
	protected Short dealType;//交易方式。参见以上常量字段
	protected java.util.Date createDate;//创建这条交易记录的时间（默认系统时间）
	protected java.util.Date transferDate;//交易时间（实际发生转账时间）
	protected String  investPersonName;//账户所属人（单位）的姓名
	...
	protected java.util.Date orderDate;//资金明细排序
