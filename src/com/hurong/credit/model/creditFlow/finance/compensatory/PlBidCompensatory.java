package com.hurong.credit.model.creditFlow.finance.compensatory;
/*
...
public class PlBidCompensatory extends com.zhiwei.core.model.BaseModel {
	...
	/**
	 * 借款客户类型：分个人客户和企业客户（person_customer  ； company_customer）
	 */
	 ...
	 * 追回总金额
	 */
	protected java.math.BigDecimal backAllMoney;
	/**
	 * 累计应收金额
	 */
	protected java.math.BigDecimal allMoney;
	...
	public java.math.BigDecimal getBackAllMoney() {
		return backAllMoney;
	}

	public void setBackAllMoney(java.math.BigDecimal backAllMoney) {
		this.backAllMoney = backAllMoney;
	}
	 ...
	 * 剩余金额
	 */
	protected java.math.BigDecimal surplusMoney;
	/**
	 * 标名称
	 */
	 ...
	 * 未偿还罚息金额
	 */
	protected java.math.BigDecimal unBackPunishMoney;
	/**
	 * 未偿还代偿金额
	 */
	protected java.math.BigDecimal unBackCompensatoryMoney;
	
	public java.math.BigDecimal getUnBackPunishMoney() {
		return unBackPunishMoney;
	}

	public void setUnBackPunishMoney(java.math.BigDecimal unBackPunishMoney) {
		this.unBackPunishMoney = unBackPunishMoney;
	}

	public java.math.BigDecimal getUnBackCompensatoryMoney() {
		return unBackCompensatoryMoney;
	}

	public void setUnBackCompensatoryMoney(
			java.math.BigDecimal unBackCompensatoryMoney) {
