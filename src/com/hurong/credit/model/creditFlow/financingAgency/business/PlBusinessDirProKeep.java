package com.hurong.credit.model.creditFlow.financingAgency.business;
/*
 ...
 * 企业直投项目维护
 */
public class PlBusinessDirProKeep extends com.hurong.core.model.BaseModel {
    @Expose
    ...
    @Expose
    protected com.hurong.credit.model.creditFlow.financingAgency.typeManger.PlKeepCreditlevel plKeepCreditlevel;
    @Expose
    protected com.hurong.credit.model.creditFlow.financingAgency.typeManger.PlKeepProtype plKeepProtype;
    @Expose
    protected com.hurong.credit.model.creditFlow.financingAgency.typeManger.PlKeepGtorz plKeepGtorz;
    //合作机构，
    /**
     * 合作机构：
     * 1、机构名称
     * 2、机构投资金额---bpfundIntent
     * 
     * **/
    @Expose
    protected String cooperationName;
    @Expose
    protected BigDecimal cooperationMoney;
    ...
    /*担保措施*/
    protected String securityMeasures;
	...
	public BigDecimal getCooperationMoney() {
		return cooperationMoney;
	}

	public void setCooperationMoney(BigDecimal cooperationMoney) {
	...
	public void setBpBusinessDirPro (com.hurong.credit.model.creditFlow.financingAgency.business.BpBusinessDirPro in_bpBusinessDirPro) {
	...
	public void setBpBusinessOrPro (com.hurong.credit.model.creditFlow.financingAgency.business.BpBusinessOrPro in_bpBusinessOrPro) {
		this.bpBusinessOrPro = in_bpBusinessOrPro;
	}
	
	public com.hurong.credit.model.creditFlow.financingAgency.typeManger.PlKeepCreditlevel getPlKeepCreditlevel () {
		return plKeepCreditlevel;
	}	
	
	public void setPlKeepCreditlevel (com.hurong.credit.model.creditFlow.financingAgency.typeManger.PlKeepCreditlevel in_plKeepCreditlevel) {
		this.plKeepCreditlevel = in_plKeepCreditlevel;
	}
	
	public com.hurong.credit.model.creditFlow.financingAgency.typeManger.PlKeepProtype getPlKeepProtype () {
		return plKeepProtype;
	}	
	
	public void setPlKeepProtype (com.hurong.credit.model.creditFlow.financingAgency.typeManger.PlKeepProtype in_plKeepProtype) {
		this.plKeepProtype = in_plKeepProtype;
	}
	
	public com.hurong.credit.model.creditFlow.financingAgency.typeManger.PlKeepGtorz getPlKeepGtorz () {
		return plKeepGtorz;
	}	
	
	public void setPlKeepGtorz (com.hurong.credit.model.creditFlow.financingAgency.typeManger.PlKeepGtorz in_plKeepGtorz) {
	...
	public void setBDirProId(Long aValue) {
	    if (aValue==null) {
	        ...
	        bpBusinessDirPro = new com.hurong.credit.model.creditFlow.financingAgency.business.BpBusinessDirPro(aValue);
	...
	public void setBOrProId(Long aValue) {
	    if (aValue==null) {
	        ...
	        bpBusinessOrPro = new com.hurong.credit.model.creditFlow.financingAgency.business.BpBusinessOrPro(aValue);
	...
	public void setTypeId(Long aValue) {
	    if (aValue==null) {
	        ...
	        plKeepProtype = new com.hurong.credit.model.creditFlow.financingAgency.typeManger.PlKeepProtype(aValue);
	...
	public void setCreditLevelId(Long aValue) {
	    if (aValue==null) {
	        ...
	        plKeepCreditlevel = new com.hurong.credit.model.creditFlow.financingAgency.typeManger.PlKeepCreditlevel(aValue);
	...
	public void setProGtOrzId(Long aValue) {
	    if (aValue==null) {
	        ...
	        plKeepGtorz = new com.hurong.credit.model.creditFlow.financingAgency.typeManger.PlKeepGtorz(aValue);
