package com.hurong.credit.model.creditFlow.smallLoan.finance;
/*
...
public class SlEarlyRepaymentRecord extends com.zhiwei.core.model.BaseModel {
    ...
    protected Integer prepayintentPeriod; //还款期数
    protected java.math.BigDecimal surplusProjectMoney;//剩余本金金额
    protected String creator;
    protected String businessType;
    protected Long bidPlanId;//招标计划的Id
    protected BigDecimal penaltyMoney;//罚息金额
