...
public class PlMmOrderChildrenOr extends com.zhiwei.core.model.BaseModel {
	...
	//不与数据库映射
	protected BigDecimal buyMoney;//购买金额
	protected BigDecimal yearRate;//预期年化收益率
	protected java.util.Date buyDate;//购买时间
	
	//债权相关信息
	protected String moneyReceiver;//原始债权人
	protected String bidName;//债权名称
	protected String days;//剩余期限
