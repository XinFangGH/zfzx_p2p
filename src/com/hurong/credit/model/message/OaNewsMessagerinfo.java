...
public class OaNewsMessagerinfo extends com.zhiwei.core.model.BaseModel {
    ...
    protected Long id;
	protected Long userId;//收件人Id
	/**
	 * P2P --P2P网站用户登陆客户类型
	 * APPUSER---ERP用户登陆客户类型
	 */
	protected String userType;//收件人用户类型
	protected String userName;//收件人用户名称
	protected Long messageId;//站内信息表Id
	/**
	 * 0    ---未发送
	 * 1    ---已删除
	 * 2    ---已发送
	 */
	protected Integer status;//站内信状态
	/**
	 * 0  ----未读
	 * 1  ----已读
	 */
	protected Integer readStatus;
	protected Date readTime;//阅读时间
