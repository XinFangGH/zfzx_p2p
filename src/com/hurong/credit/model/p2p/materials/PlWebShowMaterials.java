package com.hurong.credit.model.p2p.materials;
/*
 ...
 * p2p页面显示贷款材料清单
 */
public class PlWebShowMaterials extends com.hurong.core.model.BaseModel {
	...
	protected List<FileForm> fileFormList;
	...
	public List<FileForm> getFileFormList() {
		return fileFormList;
	}

	public void setFileFormList(List<FileForm> fileFormList) {
