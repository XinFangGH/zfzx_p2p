package com.hurong.credit.model.p2p.redMoney;
/*
...
public class BpCustRedMember extends com.zhiwei.core.model.BaseModel {
	...
	protected String requestNo;//第三方对账流水号
	protected String orderNo;//系统生成的流水号
	...
	private String intention;//红包活动操作点记录
	...
	protected String description;//活动说明
	protected String sendType;//红包发送类型
