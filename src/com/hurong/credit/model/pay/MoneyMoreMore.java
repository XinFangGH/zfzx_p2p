package com.hurong.credit.model.pay;
/*
 ...
 * 乾多多
 */
public class MoneyMoreMore extends com.hurong.core.model.BaseModel {
	//第三方支付平台id
	...
	// 公共
	public static final String PlatformMoneymoremore = "p68";
	
	public static final Double FEE_PERCENT = 0.01; // 千分之十 的收费标准

	//测试转账 收款方钱多多号
	public static final String testMoneyID="m423";
	...
	public static final String FeePercentPublic = "0";//提现费率
	public static final String Fee_MAX = "100";//用户承担的最高手续费
	private String Fee = "";
