...
public class YeePay {
	 ...
	 * 易宝支付网关修改注册手机号URL
	 */
	public static final String YEEPAYCHANGEMOBILE="member/bha/toResetMobile.action";
	/**
	 * 直接接口url
	 */
	 ...
	 * 易宝支付移动充值url
	 */
	public static final String MOBILE_YEEPAYTORECH="member/bhawireless/toRecharge.action";
	/**
	 * 易宝支付移动提现url 
	 */
	public static final String MOBILE_TOWITHDRAW = "member/bhawireless/toWithdraw.action";
	/**
	 * 易宝支付注册url
	 */
	public static final String MOBILE_YEEPAYTOREG="member/bhawireless/toRegister.action";
	/**
	 * 易宝支付移动端支付投标
	 */
	public static final String MOBILE_YEEPTOTRANSFER="member/bhawireless/toTransfer.action";
	/**
	 * 易宝支付测试绑卡url
	 */
	public static final String MOBILE_TOBINDBANKCARD="member/bhawireless/toBindBankCard";
	/**
	 * 易宝支付移动端转账
	 */
	public static final String MOBILE_YEEPAYCOMMONTTRANSFER="member/bhawireless/toCpTransaction.action";
}
