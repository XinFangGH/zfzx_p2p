...
UnFreezeOrdId ,String FreezeTrxId,String reqExt,String basePath);
	...
	/**
	 * 还款接口 2.0 version 传 20
	 * @param respose
	 * @param regType  Repayment
	 * @param ordId 订单号
	 * @param ordDate 订单时间
	 * @param OutCustId 付款人账号 id
	 * @param TransAmt 付款金额
	 ...
	 * @return
	 */
	public String[] Repayment(HttpServletResponse respose,String regType,String ordId,String ordDate,String OutCustId,String TransAmt,String Fee,String SubOrdId ,String SubOrdDate ,String InCustId ,String DivDetails ,String FeeObjFlag ,String OutAcctId ,String InAcctId ,String  reqExt,String basePath);
	/**
	 * 数据解密签名验证
	...
	public String[] webWithdraw(HttpServletResponse respose,String regType,String OrdId ,String UsrCustId ,String TransAmt ,String ServFee ,String ServFeeAcctId ,String  OpenAcctId ,String Remark ,String ReqExt ,String charSet, String timeOut,String basePath);
