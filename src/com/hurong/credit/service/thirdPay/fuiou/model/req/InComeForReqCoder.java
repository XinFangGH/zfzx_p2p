package com.hurong.credit.service.thirdPay.fuiou.model.req;
...
public class InComeForReqCoder{
    ...
    static{
        try{
            jaxbContext = JAXBContext.newInstance("com.hurong.credit.service.thirdPay.fuiou.model.req.incomefor");
