package com.hurong.credit.service.thirdPay.fuiou.model.req.refund;
...
public class ReFundReqCoder{
    ...
    static{
        try{
            jaxbContext = JAXBContext.newInstance("com.hurong.credit.service.thirdPay.fuiou.model.req.refund");
