package com.hurong.credit.service.thirdPay.fuiou.model.req.refundresend;
...
public class ReFundResendReqCoder{
    ...
    static{
        try{
            jaxbContext = JAXBContext.newInstance("com.hurong.credit.service.thirdPay.fuiou.model.req.refundresend");
