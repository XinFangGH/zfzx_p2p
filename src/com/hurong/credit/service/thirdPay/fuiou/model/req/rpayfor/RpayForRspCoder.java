package com.hurong.credit.service.thirdPay.fuiou.model.req.rpayfor;
...
public class RpayForRspCoder{
    ...
    static{
        try{
            jaxbContext = JAXBContext.newInstance("com.hurong.credit.service.thirdPay.fuiou.model.req.rpayfor");
