package com.hurong.credit.service.thirdPay.fuiou.model.rsp.refundntf;
...
public class ReFundntfRspCoder{
    ...
    static{
        try{
            jaxbContext = JAXBContext.newInstance("com.hurong.credit.service.thirdPay.fuiou.model.rsp.refundntf");
