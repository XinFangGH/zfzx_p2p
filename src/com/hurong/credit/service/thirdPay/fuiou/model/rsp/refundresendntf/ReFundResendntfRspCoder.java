package com.hurong.credit.service.thirdPay.fuiou.model.rsp.refundresendntf;
...
public class ReFundResendntfRspCoder{
    ...
    static{
        try{
            jaxbContext = JAXBContext.newInstance("com.hurong.credit.service.thirdPay.fuiou.model.rsp.refundresendntf");
