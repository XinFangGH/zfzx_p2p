...
public class YZYXMessageStrategyImpl implements MessageStrategy {
//code 未使用
	 ...
	 * 
	 * **/
	private static Log logger = LogFactory.getLog(YZYXMessageStrategyImpl.class);
	...
	public String sendMsg(String phone,String code,String content) {
		...
		if(null!=projType&&!"".equals(projType)){
			...
			String retValue = directSend(url,parseDTO(phone,code,content));
