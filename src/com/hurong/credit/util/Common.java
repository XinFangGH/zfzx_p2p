...
public class Common
{
	...
	public static boolean sql_inj(String str){
		...
		String inj_str = "'|and|exec|insert|select|delete|update|count|*|%|chr|mid|master|truncate|char|declare|;|" +
				"or|--|+|,|&|sleep|if|sysdate|now|where|create|alter|add|as|start|end|drop|limit|begin|case|wher|then|" +
				"from|set|database|version|table|column_name|user|information_schema|union|user|mysql|replace|unhex";
