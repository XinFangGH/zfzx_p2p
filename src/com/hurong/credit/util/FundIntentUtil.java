...
public class FundIntentUtil{
	...
	public static BigDecimal getP2PInterest(Long precentId,Long investPersonId,String orderNo)throws Exception{
	...
	public static BigDecimal getP2PPrincipal(Long precentId,Long investPersonId,String orderNo)throws Exception{
		if(null==precentId||"".equals(precentId)){
			throw new Exception("传入recentId为空!");
		}
		if(null==investPersonId||"".equals(investPersonId)){
