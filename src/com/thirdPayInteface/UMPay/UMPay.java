...
public class UMPay {
	...
	public static final String NOTIFY_WITHDRAW="withdraw_apply_notify";//取现回调通知service标识  withdraw_notify
	public static final String NOTIFY_BINDCARD="mer_bind_card_apply_notify";//绑银行卡回调通知service标识
