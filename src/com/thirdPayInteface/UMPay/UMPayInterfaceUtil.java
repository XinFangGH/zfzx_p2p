	...
	public static Object[] createBidAccount(CommonRequst commonRequst) {
		try{
			...
			if(true){
				if(htmlReturnMap.get("ret_code").equals("0000")){
					//更新标
					Object[] obj = ThirdPayInterfaceUtil.UpdateBidAccount(ThirdPayConstants.BUSSINESSTYPE_UPDATEBID,commonRequst.getBidId(),commonRequst.getBidType(),"0");
					if(obj[0].toString().equals(Constants.CODE_SUCCESS)){
						Object[] rets = ThirdPayInterfaceUtil.UpdateBidAccount(ThirdPayConstants.BUSSINESSTYPE_UPDATEBID,commonRequst.getBidId(),commonRequst.getBidType(),"1");
						if(rets[0].toString().equals(Constants.CODE_SUCCESS)){
							backData[0]=ThirdPayConstants.RECOD_SUCCESS;
							backData[1]=htmlReturnMap;
							backData[2]=commonRequst;
						}else{
