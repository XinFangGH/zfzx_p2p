...
public class YeePayInterfaceUtil {
	...
	private static String yeePayUrl(){
		...
		//易宝支付调用地址
		String yeepayurl=yeePayConfigMap.get("thirdPay_yeepay_URL").toString();
		return yeePayUrl;
	}
	...
	private static Map yeePayProperty(){
		...
		try{
			if(thirdPayEnvironmentType.equals(ThirdPayConstants.THIRDENVIRONMENT0)){//正式环境
				yeePayConfigMap=configMap;
			}else{
				Properties props =  new  Properties();    
		        InputStream in =  YeePayInterfaceUtil.class.getResourceAsStream("YeePayTestEnvironment.properties"); 
		    	props.load(in);
	...
	public static Properties getyeePayProperties() {
		InputStream inputStream = Object.class.getResourceAsStream("/com/thirdPayInteface/YeePay/YeePay.properties");   
...
//==================================接口开始=========================================
	 ...
	 * @return
	 */
	public static Object[] enterRegister(CommonRequst commonRequst){
		...
		try{
			...
			if(yeepay!=null){
				...
				System.out.println(params);
				//易宝支付调用地址
				String yeepayurl="http://220.181.25.233:8081/";
			...
			e.printStackTrace();
			ret[0]=ThirdPayConstants.RECOD_FAILD;
			ret[1]="企业用户注册接口对接失败"+e.getMessage();
			ret[2]=commonRequst;
		}
		return ret;
	}
	...
	public static Object[] recharge(CommonRequst commonRequst) {
		...
		try{
			...
			e.printStackTrace();
			ret[0]=ThirdPayConstants.RECOD_FAILD;
			ret[1]="网关用户充值接口对接失败"+e.getMessage();
			ret[2]=commonRequst;
		}
		return ret;
	}
	 ...
	 * @return
	 */
	public static Object[] loan(CommonRequst commonRequst){
