...
public class Fuiou{
	 ...
	 * 01富有金账户数据流个人注册url
	 */
	public static final String FUIOUGOLDREG="/webReg.action";
	/**
	 * 02富有金账户网页版个人注册url
	 */
	public static final String FUIOUGOLDWEBRECHARGE="/webReg.action";//"webReg.action";
	/**
	 * 03富有金账户数据流企业户注册URL
	 */
	 ...
	 *富有充值借口 
	 */
	public static final String FUIOURECHARGE="/500002.action";
	
	/**
	 *富友修改密码接口 
	 */
	public static final String FUIOUCHANGEPASS = "/resetPassWord.action";
	/**
	 *用户密码修改重置免登陆接口(app版)
	 */
	public static final String FUIOUCHANGEPASS_APP ="/app/appResetPassWord.action";
	/**
	 * 用户修改绑定手机号码(pc,app)
	 * 
	 */
	public static final String FUIOUCHANGEPHONE = "/400101.action";
	/**
	 * 用户app免登陆快速充值
	 */
	public static final String FUIOUAPPQRECHARGE="/app/500001.action";
	/**
	 * 用户免登录快速充值接口
	 */
	public static final String FUIOURECHARGEQUICK = "/500001.action";
	/**
	 * 商户代码
	 */
	...
	public void setUser_bankCards(String userBankCards) {
		user_bankCards = userBankCards;
	}
	public String getUser_idNos() {
		return user_idNos;
	}
	public void setUser_idNos(String userIdNos) {
		user_idNos = userIdNos;
	}
