...
public class ThirdPayConstants {
	 ...
	 * 手机app免登陆快速充值
	 */
	public static final String BT_APPQRECHARGE="hry10009";
	public static final String TN_APPQRECHARGE="app个人免登陆快速充值";
	/**
	 * 手机app免登陆提现
	 */
	public static final String BT_APPWITHDRAW="hry10010";
	public static final String TN_APPWITHDRAW="app个人免登陆取现";
	/**
	 * 通用转账授权审核
	 */
	 ...
	 * 查询订单
	 */
	public static final String BT_UPDATEFILE="hry10013";
	public static final String TN_UPDATEFILE="数据迁移接口";

	/**
	 * 查询订单
	 */
	public static final String BT_MODIFY="hry10014";
	public static final String TN_MODIFY="企业信息变更接口";
    /**
     * 企业取消绑定银行卡
     */
    public static final String BT_CANCELCARDBIND="hry10015";
    public static final String TN_CANCELCARDBIND="企业取消绑定银行卡";
	 ...
	 * 投资人回款
	 */
	public static final String BT_CALLBACK="hry20021";
	public static final String TN_CALLBACK="投资人回款";
	/**
	 * 查询标的信息
	 */
	public static final String BT_QUERYLOAN="hry20022";
	public static final String TN_QUERYLOAN="查询标的三方账户";
	/**
	 * 查询标的流水
	 */
	public static final String BT_QUERYLOANBALANCE="hry20023";
	public static final String TN_QUERYLOANBALANCE="查询标的三方账户流水";
	/**
	 * 平台帮助借款人还款
	 */
	 ...
	 * 放款授权
	 */
	public static final String BT_AUTOLOAN="hry20018";
	public static final String TN_AUTOLOAN="放款授权";
	/**
	 * 散标自助批量还款
	 */
	public static final String BT_BATCHREPAYMENT="hry20019";
	public static final String TN_BATCHREPAYMENT="散标自助批量还款";
	/**
	 * 担保公司代偿还款
	 */
	public static final String BT_COMPENSATORY="hry20020";
	public static final String TN_COMPENSATORY="担保公司代偿还款";
	/**
	...
	/**
	 * 理财计划提前退出(收款账户为用户)P2P前台操作
	 */
	public static final String BT_MMADVANCEUSER="hry30013";
	public static final String TN_MMADVANCEUSER="理财计划提前退出(收款账户为用户)";
	...
	public static final String TN_SEDRED="平台派发红包";
	/**
	 * 优惠券派发奖励
	 */
	 ...
	 *平台收费 （平台还款）
	 */
	public static final String BT_PLATEFORMRECHAGE_B="hry50009";
	public static final String TN_PLATEFORMRECHAGE_B="平台收取手续费(提前还款)";
	/**
	 ...
	 * 用户更改密码(网页)
	 */
	public static final String BT_CHANGEPASS = "hry60015";
	public static final String TN_CHANGEPASS = "用户更改密码(网页)";
	
	/**
	 * 用户更改密码(APP)
	 */
	public static final String BT_CHANGEPASSAPP = "hry60015";
	public static final String TN_CHANGEPASSAPP = "用户更改密码(网页)";
	/**
	 * 用户申请注销
	 */
	public static final String BT_CANCELUSER = "hry60016";
	public static final String TN_CANCELUSER = "用户免登录注销用户(网页)";
	
	/**
	 * 企业户开户查询
	 */
	public static final String BT_CHECKREIGSTER = "hry60017";
	public static final String TN_CHECKREIGSTER ="企业户开户查询";
	/**
	 * 系统支持调用接口类型-注册接口
	 */
	 ...
	 * 个人注册
	 */
	public static final String BUSSINESSNAME_REGISTERENTERPRISE="bussinessname_registerenterprise";
	/**
	 * 企业注册
	 */
	public static final String BUSSINESSNAME_REGISTERPERSON="bussinessname_registerperson";
	 ...
	 * 系统支持调用接口类型用途-散标投标用途
	 */
	public static final String BUSSINESSNAME_BID="bussinessname_bid";
	/**
	 * 系统支持调用接口类型-取消投标接口
	 */
	...
	/**
	 * 系统支持调用接口类型-自动投标授权接口(如果第三方是双乾，则还款、二次分配审核一起授权)
	 */
	public static final String BUSSINESSTYPE_AUTOBID="bussinessType_autoBid";
	/**
	 * 系统支持调用接口类型-关闭自动投标授权接口(如果第三方是双乾，则还款、二次分配审核一起关闭授权)
	 */
	...
	/**
	 * 系统支持调用接口类型用途-散标无密还款授权用途
	 */
	public static final String BUSSINESSNAME_NOPWREPAYMENT="bussinessname_nopwrepayment";
	/**
	 ...
	 * 系统支持调用接口用途-挂牌交易
	 */
	public static final String BUSSINESSNAME_STARTTRANSFER="bussinessname_starttransfer";
	/**
	 * 系统支持调用接口用途 ------购买理财收款方为平台
	 */
	public static final String BUSSINESSNAME_MMPLAN="bussinessname_mmplan";
	/**
	 * 系统支持调用接口用途 ------购买理财收款方为注册用户
	 */
	public static final String BUSSINESSNAME_PLANCUST="bussinessname_planCust";
	/**
	 * 系统支持调用接口用途 ------代偿还款
	 */
