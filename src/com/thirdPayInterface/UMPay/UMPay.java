...
public class UMPay {
	...
	public static final String SER_BINDCARD="ptp_mer_bind_card";//绑卡接口
	public static final String SER_REPLACECARD="ptp_mer_replace_card";//更换银行卡
	public static final String SER_NOPASSWORD="ptp_mer_bind_agreement";//授权接口
	...
	public static final String SER_ENPRISE_WITHDARW="mer_withdrawals";//企业客户取现接口
	public static final String SER_NOPWDTRANSFER="project_transfer_nopwd";//无密转账接口
	//接口名称(每个接口都不同)
    ...
    private String loan_acc_type;//商户号必填
	...
	public void setWithdraw_mer_id(String withdrawMerId) {
		withdraw_mer_id = withdrawMerId;
	}
