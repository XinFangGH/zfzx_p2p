...
public class YeePay {
	 ...
	 * 易宝支付个人用户注册手机端url
	 */
	public static final String YEEPAYTOREG_MOBILE="member/bhawireless/toRegister.action";
	/** 
	 * 易宝支付企业客户注册方法
	 */
	 ...
	 * 易宝支付企业客户注册方法手机端地址
	 */
	public static final String ENTERPRISEREGISTER_MOBILE="member/bhawireless/toEnterpriseRegister.action";
	/**
	 * 易宝支付用户提现url 
	 */
	 ...
	 *易宝支付用户提现手机端url 
	 */
	public static final String TOWITHDRAW_MOBILE="member/bhawireless/toWithdraw.action"; 
	 ...
	 * 易宝支付用户绑卡手机端url
	 */
	public static final String TOBINDBANKCARD_MOBILE="member/bhawireless/toBindBankCard.action";
	 ...
	 *易宝手机充值网关 
	 */
	 public static final String YEEPAYTORECH_MOBILE =  "member/bhawireless/toRecharge.action";
	/**
	 * 易宝支付投标URL
	 */
	 ...
	 * 易宝手机支付投标URL
	 */
	public static final String YEEPTOTRANSFER_MOBILE="member/bhawireless/toTransfer.action";
	...
	/**
	 * 易宝支付网关自动投标授权接口手机端URL
	 */
	public static final String YEEPAYTOAUTHORIZEAUTOTRANSFER_MOBILE="member/bhawireless/toAuthorizeAutoTransfer.action"; 
	/**
	 * 易宝支付网关自动还款授权接口URL
	 */
	public static final String YEEPAYTOAUTHORIZEAUTOREPAYMENT="member/bha/toAuthorizeAutoRepayment.action";
	/**
	 * 易宝支付网关自动还款授权接口手机端URL
	 */
	public static final String YEEPAYTOAUTHORIZEAUTOREPAYMENT_MOBILE="member/bhawireless/toAuthorizeAutoRepayment.action";
	/**
	 * 易宝支付网关还款接口
	 */
	 ...
	 * 易宝支付网关还款接口手机端
	 */
	public static final String YEEPAYTOREPAYMENT_MOBILE="member/bhawireless/toRepayment.action"; 
	 ...
	 * 易宝支付网关债权交易手机端URL
	 */
	public static final String YEEPAYTRANSFERDEALINTEFACE_MOBILE="member/bhawireless/toTransferClaims.action";
	/**
	 * 易宝支付网关取消绑卡URL
	 */
	 ...
	 * 易宝支付网关通用转账交易手机端URL
	 */
	public static final String YEEPAYCOMMONTTRANSFER_MOBILE="member/bhawireless/toCpTransaction.action";
	/**
	 * 易宝支付网关重置交易密码接口
	 */
	 ...
	 * 易宝支付网关修改手机号接口手机端
	 */
	public static final String YEEPAYTORESETMOBILE_MOBILE="member/bhawireless/toResetMobile.action";
	/**
	 * 直接接口测试url
	 */
