...
public class YeePaySecretKeyUtil {
	private static Map configMap = YeePayInterfaceUtil.yeePayProperty();
	/**
	 * 将实体对象封装成Map对象
	 * @param type
	 * @param obj
	...
	public static Boolean verifySignature(String signature, String trim) {
		...
		ret=rsa.verifySignature(trim,data, AppUtil.getSysConfig().get("MM_PublicKey").toString());
		return ret;
	}
}
